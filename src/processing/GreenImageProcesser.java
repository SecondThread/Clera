...
/**
 * This class has the process method that process the image so that makes
 * OUTSTANDING green color pixel into a 1 and everything else into a 0
 * 
 * @author jialuo
 * 
 */
public class GreenImageProcesser {
	 ...
	 * 
	 * @param redIndex
	 *            : multiplier of red color value, domain from 0f to -1f
	 *            recommended input: -0.2f to -0.4f for bright camera -0.4f to
	 *            -0.7f for dim camera -0.7f to -0.9f for very dim camera
	 * @param greenIndex
	 *            : multiplier of green color value, domain from 0f to 1f
	 *            recommended input: 1f
	 * @param blueIndex
	 *            : multiplier of red color value, domain from 0f to -1f
	 *            recommended input: same as red
	 * @param upperBound
	 *            : remove all point that values below this bound recommended
	 *            input: for input G/R of -0.2 to -0.4f : 0.7 to 0.9 for input
	 *            G/R of -0.4f to -0.7f : 0.4 to 0.7 for input G/R of -0.7f to
	 *            -0.9f : 0.1 to 0.4
	 */
	...
	/**
	 * The process method makes OUTSTANDING green color pixel into a 1 and
	 * everything else into a 0
	 * 
	 * @param image:
	 *            input BufferedImage that needed to be processed
